...
```mermaid
flowchart TD
    Auftraggeber["👔 Auftraggeber<br>(Organisation)"]
    Mediator["🧑‍⚖️ Mediator:in"]
    Mediand["🧑 Mediand:in"]

    Auftraggeber -->|"Auftrag, Zielrahmen"| Mediator
    Mediator -->|"Arbeitsbündnis<br>Vertraulichkeit"| Mediand
    Auftraggeber -.->|"ggf. Rückmeldung mit Zustimmung"| Mediand
    Mediand -.->|"Veränderung sichtbar machen"| Auftraggeber

    style Auftraggeber fill:#f0f0f0,stroke:#333
    style Mediator fill:#e0f7fa,stroke:#333
    style Mediand fill:#fce4ec,stroke:#333
```
