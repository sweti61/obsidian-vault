...
## 4. Änderungen gegenüber v0.3

Version 0.4 übernimmt den Stand von v0.3 und ergänzt die inzwischen beschlossenen Regeln zur Gestaltung und Nutzung von Datenbank-Templates:

- **DR-26:** Fachkataloge erhalten bewusst vereinfachte Seitenlayouts und Templates.
- **DR-27:** Templates werden ausdrücklich als schlanke Erfassungsoberflächen und damit als Teil der UI verstanden.
- **DR-28:** Templates werden aus der tatsächlichen Arbeitsweise weiterentwickelt und nicht vorsorglich überstrukturiert.
- **DR-29:** Templates sollen durch ihre Struktur Orientierung geben, ohne eine eigene Gebrauchsanweisung zu benötigen.

Damit wird die bereits in DR-02 bis DR-04 angelegte Template-Logik konkretisiert: Templates bauen auf Seitenlayouts auf, strukturieren wiederkehrenden narrativen Inhalt und müssen Arbeit sparen. Die neuen Regeln schärfen insbesondere die Anforderungen **schlank, arbeitsnah und nicht bürokratisch** für RM und Content Hub.
